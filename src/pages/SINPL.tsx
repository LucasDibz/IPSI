  ...
  return (
    <>
      <Body variant='sinpl' className='pt-32' showImage>
        <div className='grid lg:grid-cols-[1fr_auto] lg:items-start gap-6 w-full'>
          <Body.Section>
            <Card className='bg-white rounded-[3rem] max-w-full'>
              ...
              <Card.Content className='md:text-justify flex flex-col gap-2 leading-relaxed'>
                <p>
                  At the NOVA School of Law the focus on Intellectual Property
                  and Sustainability has been growing through our research
                  interests and activities at NOVA IPSI and, since 2024, also
                  thanks to the
          ...
          <Card className='bg-white rounded-[3rem] lg:sticky lg:top-60 lg:mt-72 xl:mt-96'>
            <Card.Header>
